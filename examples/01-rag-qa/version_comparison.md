...
| DSPy | Task LM | Reflection LM | Baseline | Optimized | Δ | Baseline Time | Optimize Time |
|---|---|---|---:|---:|---:|---:|---:|
...
- DSPy 3.1.3 cache: `<temp workspace>/repo/.cache-rag-313`
- DSPy 3.2.0 cache: `<temp workspace>/repo/.cache-rag-320`
